...
class TestViews(TestCase):
    ...
    def test_play_plenty(self):
        ...
        data = {"type": "play_year_of_plenty_card",
                "payload": ["brick", "lumber"]}
    ...
    def test_no_card(self):
        ...
        view = PlayerActions.as_view()
        response = view(request, pk=1)
        assert response.data == {"detail": "You have not year of plenty card"}
    ...
    def test_get_monopoly(self):
        ...
        view = PlayerActions.as_view()
        response = view(request, pk=1)
        assert {"type": 'play_year_of_plenty_card'} in response.data
        assert response.status_code == 200
