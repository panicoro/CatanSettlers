...
class TestViews(TestCase):
    ...
    def setUp(self):
        ...
        self.vert_position3 = VertexPosition.objects.create(level=2, index=29)
        #self.vert_position4 = VertexPosition.objects.create(level=1, index=17)
        #self.vert_position5 = VertexPosition.objects.create(level=1, index=0)
    ...
    def test_not_turn(self):
        user = User.objects.create_user(username='markco', email='markco@gmail.com')
        self.turn.user = user
        self.turn.save()
